...
const DAY_OVERRIDES: Record<number, DayOverride> = {
  77: {
    commits: [
      { sha: '5508505', message: "fix: add Day 76 real data override for re-render", repo: 'agentsea', timestamp: '' },
      { sha: '90e400b', message: "mint: Corrupt Memory Day 76 — Meridian", repo: 'agentsea', timestamp: '' },
    ],
  ...
  76: {
    commits: [
      { sha: '3014936', message: "fix: add Day 75 real data override for re-render", repo: 'agentsea', timestamp: '' },
      { sha: '12bf619', message: "mint: Corrupt Memory Day 75 — Golden Hour", repo: 'agentsea', timestamp: '' },
    ],
    reposActive: ["agentsea"],
    replies: { twitter: [], farcaster: [], combined: [] },
  },
  ...
  74: {
    commits: [
      ...
      { sha: 'ef15bb7', message: "mint: Corrupt Memory Day 73 — Golden Hour", repo: 'agentsea', timestamp: '' },
    ],
    reposActive: ["agentsea"],
    replies: { twitter: [], farcaster: [], combined: [] },
  },
  ...
  73: {
    commits: [
      { sha: 'd5b6837', message: "fix: add Day 72 real data override for re-render", repo: 'agentsea', timestamp: '' },
      { sha: 'db2450d', message: "mint: Corrupt Memory Day 72 — Meridian", repo: 'agentsea', timestamp: '' },
    ],
    reposActive: ["agentsea"],
    replies: { twitter: [], farcaster: [], combined: [] },
  },
  ...
  72: {
    commits: [
      { sha: '02e3cec', message: "fix: add Day 71 real data override for re-render", repo: 'agentsea', timestamp: '' },
      { sha: 'e2ae412', message: "mint: Corrupt Memory Day 71 — Meridian", repo: 'agentsea', timestamp: '' },
    ],
    reposActive: ["agentsea"],
    replies: { twitter: [], farcaster: [], combined: [] },
  },
  ...
  71: {
    commits: [
      { sha: '2703e1c', message: "fix: add Day 70 real data override for re-render", repo: 'agentsea', timestamp: '' },
      { sha: '3ab2078', message: "mint: Corrupt Memory Day 70 — Golden Hour", repo: 'agentsea', timestamp: '' },
    ],
    reposActive: ["agentsea"],
    replies: { twitter: [], farcaster: [], combined: [] },
  },
  ...
  70: {
    commits: [
      { sha: '2072caf', message: "fix: add Day 69 real data override for re-render", repo: 'agentsea', timestamp: '' },
      { sha: 'f284a27', message: "mint: Corrupt Memory Day 69 — Meridian", repo: 'agentsea', timestamp: '' },
    ],
    reposActive: ["agentsea"],
    replies: { twitter: [], farcaster: [], combined: [] },
  },
  ...
  69: {
    commits: [
      { sha: 'e4594f0', message: "fix: add Day 68 real data override for re-render", repo: 'agentsea', timestamp: '' },
      { sha: '9a42442', message: "mint: Corrupt Memory Day 68 — Golden Hour", repo: 'agentsea', timestamp: '' },
    ],
    reposActive: ["agentsea"],
    replies: { twitter: [], farcaster: [], combined: [] },
  },
  ...
  68: {
    commits: [
      { sha: 'd78c86d', message: "fix: add Day 67 real data override for re-render", repo: 'agentsea', timestamp: '' },
      { sha: '80ad1f8', message: "mint: Corrupt Memory Day 67 — Meridian", repo: 'agentsea', timestamp: '' },
    ],
    reposActive: ["agentsea"],
    replies: { twitter: [], farcaster: [], combined: [] },
  },
  ...
  67: {
    commits: [
      { sha: '45a1a4e', message: "fix: add Day 66 real data override for re-render", repo: 'agentsea', timestamp: '' },
      { sha: '4923a33', message: "mint: Corrupt Memory Day 66 — Meridian", repo: 'agentsea', timestamp: '' },
    ],
    reposActive: ["agentsea"],
    replies: { twitter: [], farcaster: [], combined: [] },
  },
  ...
  66: {
    commits: [
      { sha: '9720e52', message: "fix: add Day 65 real data override for re-render", repo: 'agentsea', timestamp: '' },
      { sha: '2074a7c', message: "mint: Corrupt Memory Day 65 — Meridian", repo: 'agentsea', timestamp: '' },
    ],
    reposActive: ["agentsea"],
    replies: { twitter: [], farcaster: [], combined: [] },
  },
  ...
  65: {
    commits: [
      { sha: '5457dce', message: "fix: add Day 64 real data override for re-render", repo: 'agentsea', timestamp: '' },
      { sha: '8b78f40', message: "mint: Corrupt Memory Day 64 — Golden Hour", repo: 'agentsea', timestamp: '' },
    ],
    reposActive: ["agentsea"],
    replies: { twitter: [], farcaster: [], combined: [] },
  },
  ...
  64: {
    commits: [
      { sha: '9df2684', message: "fix: add Day 63 real data override for re-render", repo: 'agentsea', timestamp: '' },
      { sha: '9f1b665', message: "mint: Corrupt Memory Day 63 — Meridian", repo: 'agentsea', timestamp: '' },
    ],
    reposActive: ["agentsea"],
    replies: { twitter: [], farcaster: [], combined: [] },
  },
  ...
  63: {
    commits: [
      { sha: 'f5d677d', message: "fix: add Day 62 real data override for re-render", repo: 'agentsea', timestamp: '' },
      { sha: 'e30e89c', message: "mint: Corrupt Memory Day 62 — Golden Hour", repo: 'agentsea', timestamp: '' },
    ],
    reposActive: ["agentsea"],
    replies: { twitter: [], farcaster: [], combined: [] },
  },
  ...
  62: {
    commits: [
      { sha: 'd148ec6', message: "fix: add Day 61 real data override for re-render", repo: 'agentsea', timestamp: '' },
      { sha: 'ac26d7e', message: "mint: Corrupt Memory Day 61 — Meridian", repo: 'agentsea', timestamp: '' },
    ],
    reposActive: ["agentsea"],
    replies: { twitter: [], farcaster: [], combined: [] },
  },
  ...
  59: {
    commits: [
      ...
      { sha: '8757f4b', message: "fix: add Day 58 real data override for re-render", repo: 'agentsea', timestamp: '' },
      { sha: '36ac29b', message: "mint: Corrupt Memory Day 58 — Meridian", repo: 'agentsea', timestamp: '' },
      { sha: '1f23ba83', message: "compound: daily review 2026-04-27", repo: 'clawdia-glitch', timestamp: '' },
    ],
    reposActive: ["clawd","agentsea"],
    replies: { twitter: [], farcaster: [], combined: [] },
  },
  ...
  58: {
    commits: [
      { sha: '196802d', message: "fix: add Day 57 real data override for re-render", repo: 'agentsea', timestamp: '' },
      { sha: 'dab497a', message: "mint: Corrupt Memory Day 57 — Meridian", repo: 'agentsea', timestamp: '' },
    ],
    reposActive: ["agentsea"],
    replies: { twitter: [], farcaster: [], combined: [] },
  },
  ...
  56: {
    commits: [
      ...
      { sha: '129edaf', message: "mint: Corrupt Memory Day 55 — Meridian", repo: 'agentsea', timestamp: '' },
    ],
    reposActive: ["agentsea"],
    replies: { twitter: [], farcaster: [], combined: [] },
  },
  ...
  55: {
    commits: [
      { sha: '8682b73', message: "fix: add Day 54 real data override for re-render", repo: 'agentsea', timestamp: '' },
      { sha: '8d2b2c0', message: "mint: Corrupt Memory Day 54 — Meridian", repo: 'agentsea', timestamp: '' },
    ],
    reposActive: ["agentsea"],
    replies: { twitter: [], farcaster: [], combined: [] },
  },
